...
export default function Calculator() {
  ...
  return (
    <div className="wrapper">
      ...
      <button type="button" onClick={clickHandler} className="greyBtn">AC</button>
      ...
      <button type="button" onClick={clickHandler} className="greyBtn">9</button>
      ...
      <button type="button" onClick={clickHandler} className="greyBtn">2</button>
